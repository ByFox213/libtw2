#![allow(clippy::cast_lossless, clippy::cast_possible_truncation, clippy::cast_possible_wrap, clippy::cast_sign_loss, clippy::cast_precision_loss, clippy::doc_markdown, clippy::enum_glob_use, clippy::large_enum_variant, clippy::missing_errors_doc, clippy::missing_panics_doc, clippy::module_name_repetitions, clippy::must_use_candidate, clippy::redundant_field_names, clippy::similar_names, clippy::too_many_lines, clippy::type_complexity, clippy::used_underscore_binding, clippy::unwrap_used, clippy::expect_used, clippy::semicolon_if_nothing_returned, clippy::needless_lifetimes, clippy::uninlined_format_args, clippy::default_trait_access, clippy::nonminimal_bool, clippy::cloned_instead_of_copied, clippy::single_match_else, clippy::manual_range_contains, clippy::items_after_statements, clippy::needless_borrow, clippy::derivable_impls, clippy::let_underscore_future, clippy::iter_without_into_iter, clippy::needless_late_init, clippy::print_literal, clippy::if_not_else, clippy::explicit_iter_loop, clippy::println_empty_string, clippy::needless_pass_by_value, clippy::single_match, clippy::elidable_lifetime_names)]
